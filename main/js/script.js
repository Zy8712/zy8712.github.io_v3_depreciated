...
function changeNavBar(){
  if (navbar_minimized == false){
    ...
    $("nav-option1").title = "About";
    $("nav-option2").title = "Experience";
    $("nav-option3").title = "Projects";
    $("nav-option4").title = "Contact";
    ...
    $("nav-option1").innerHTML = "About";
    $("nav-option2").innerHTML = "Experience";
    $("nav-option3").innerHTML = "Projects";
    $("nav-option4").innerHTML = "Contact";
